...
public class EventGenerator {
     ...
     * Constructor
     * 
     * @param policeActivity The amount of police activity in the area. Positive
     *          integer.
     * @param pirateActivity The amount of pirate activity in the area. Positive
     *          integer.
     * @param reputation The player's reputation. If positive, increases pirate
     *          encounter chance. If negative, increases police encounter chance.
     * @param cargo The amount of cargo the ship currently has.
     * @param dist The distance the ship is traveling
     */
    public EventGenerator(int policeActivity, int pirateActivity, int reputation, int cargo, int dist) {
