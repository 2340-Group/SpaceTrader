...
//	System.out.println("Making Universe");
	...
	// Create Space system
	S1 = new Planet("S1", randomGenerator.nextInt(201),
		randomGenerator.nextInt(201), 1, 0);
	S2 = new Planet("S2", randomGenerator.nextInt(201),
		randomGenerator.nextInt(201), randomGenerator.nextInt(7) + 1,
		randomGenerator.nextInt(13));
	S3 = new Planet("S3", randomGenerator.nextInt(201),
		randomGenerator.nextInt(201), randomGenerator.nextInt(7) + 1,
		randomGenerator.nextInt(13));
	S3PT2 = new Planet("S3PT2", randomGenerator.nextInt(201),
		randomGenerator.nextInt(201), randomGenerator.nextInt(7) + 1,
		randomGenerator.nextInt(13));
	YNS = new Planet("Your Naming Sucks", randomGenerator.nextInt(201),
		randomGenerator.nextInt(201), randomGenerator.nextInt(7) + 1,
		randomGenerator.nextInt(13));
	SpaceSystem.add(S1);
	SpaceSystem.add(S2);
	...
	// Create Name System
	Big = new Planet("Big", randomGenerator.nextInt(201) + 200,
		randomGenerator.nextInt(201) + 200,
		randomGenerator.nextInt(7) + 1, randomGenerator.nextInt(13));
	Giant = new Planet("Giant", randomGenerator.nextInt(201) + 200,
		randomGenerator.nextInt(201) + 200,
		randomGenerator.nextInt(7) + 1, randomGenerator.nextInt(13));
	Planet = new Planet("Planet", randomGenerator.nextInt(201) + 200,
		randomGenerator.nextInt(201) + 200,
		randomGenerator.nextInt(7) + 1, randomGenerator.nextInt(13));
	NameSystem.add(Big);
	...
	ERROR = new Planet("ERROR", randomGenerator.nextInt(201) + 400,
		randomGenerator.nextInt(201), 7, 12);
	InsertName = new Planet("InsertName",
		randomGenerator.nextInt(201) + 400,
		randomGenerator.nextInt(201), randomGenerator.nextInt(7) + 1,
		randomGenerator.nextInt(13));
	Blank = new Planet("Blank", randomGenerator.nextInt(201) + 400,
		randomGenerator.nextInt(201), randomGenerator.nextInt(7) + 1,
		randomGenerator.nextInt(13));
	...
	universeList.add(Space);
	universeList.add(Name);
	universeList.add(NoName);
